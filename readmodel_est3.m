function [m,p,mss] = readmodel_est3()
...
p.u2           = 0.4503;
%% == Standard deviations ===
p.std_SHK_L_GDP_GAP=1.75;%3.5;%4.0;
p.std_SHK_DLA_CPI= 1.85;%2.5;%6;%0.25;%2; %1.2993; %1.3260
p.std_SHK_L_S= 5.5;%5; %10 %5.8057
p.std_SHK_RS= 2.35; %0.50
p.std_SHK_D4L_CPI_TAR= 0.45;
p.std_SHK_RR_BAR= 0.5;%0.6308;
p.std_SHK_DLA_Z_BAR= 5.5;%13;
p.std_SHK_DLA_GDP_BAR= 0.5;
p.std_SHK_L_GDP_RW_GAP= 4.20;
p.std_SHK_RS_RW= 0.07;%0.3641;
p.std_SHK_DLA_CPI_RW= 1.9;%2.74;%3.1552;
p.std_SHK_RR_RW_BAR= 0.08;%0.2;
p.std_SHK_UNEM_BAR= 0.8531; %0.7488
p.std_SHK_DLA_UNEM_BAR= 0.3119; %0.4882
p.std_SHK_UNEM_GAP= 0.1828; %0.3208 
p.std_SHK_L_GDP_BAR= 2.75;%2.30;
